    ...
    return (
        <section class="bg-white dark:bg-gray-900">
            <div class="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
                <img class="w-full dark:hidden" src="src/assets/adv2.png" alt="dashboard image" />
                <img class="w-full hidden dark:block" src="src/assets/adv2.png" alt="dashboard image" />
                <div class="mt-4 md:mt-0">
                    <div class="features-list flex items-center gap-4 mb-6 mt-6">
                        <img src='src/assets/star-adv2.png' class=""></img>
