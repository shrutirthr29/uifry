            ...
            <div class="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
                <div class="mt-4 md:mt-0">
                    ...
                    <div class="features-list flex items-center gap-4 mb-6 mt-6">
                        <img src='/assets/notifi.png' class=""></img>
                ...
                <img class="w-full dark:hidden" src="/assets/adv.png" alt="dashboard image" />
                <img class="w-full hidden dark:block" src="/assets/adv.png" alt="dashboard image" />
            </div>
        </section>
    )
}