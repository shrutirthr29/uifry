    ...
    return (
        ...
        <h3 class="mb-0 text-center text-4l tracking-wider font-bold text-gray-900 dark:text-white">TESTIMONIAL</h3>
            ...
            <div class="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
                <img class="w-full dark:hidden" src="/assets/testimonial.png" alt="dashboard image" />
                <img class="w-full hidden dark:block" src="/assets/testimonial.png" alt="dashboard image" />
                <div class="w-96 mt-4 md:mt-0">
                    ...
                    <img src="/assets/users.png" class="mb-6"></img>
